...
namespace RMS.Data.Migrations
{
    ...
    [Migration("20240629181944_NewDatatype")]
            ...
            modelBuilder.Entity("RMS.Core.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 29, 22, 19, 42, 724, DateTimeKind.Utc).AddTicks(3474));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 22, 19, 42, 724, DateTimeKind.Utc).AddTicks(6931));
                    ...
                    b.Property<DateTime>("ReservationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 0, 0, 0, 0, DateTimeKind.Utc));

                    b.Property<TimeSpan>("ReservationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("time")
                        .HasDefaultValue(new TimeSpan(0, 22, 19, 0, 0));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Slide", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 22, 19, 42, 724, DateTimeKind.Utc).AddTicks(9340));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Table", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 29, 22, 19, 42, 725, DateTimeKind.Utc).AddTicks(1726));
