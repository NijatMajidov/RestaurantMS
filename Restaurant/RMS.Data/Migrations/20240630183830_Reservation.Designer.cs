...
namespace RMS.Data.Migrations
{
    ...
    [Migration("20240630183830_Reservation")]
            ...
            modelBuilder.Entity("RMS.Core.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 38, 29, 164, DateTimeKind.Utc).AddTicks(7135));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 38, 29, 165, DateTimeKind.Utc).AddTicks(4203));
                    ...
                    b.Property<TimeSpan>("ReservationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("time")
                        .HasDefaultValue(new TimeSpan(0, 22, 38, 0, 0));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Slide", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 38, 29, 165, DateTimeKind.Utc).AddTicks(9379));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Table", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 38, 29, 166, DateTimeKind.Utc).AddTicks(5244));
