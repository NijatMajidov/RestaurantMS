...
namespace RMS.Data.Migrations
{
    ...
    [Migration("20240630180511_UpdateReservationTable")]
            ...
            modelBuilder.Entity("RMS.Core.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 5, 10, 437, DateTimeKind.Utc).AddTicks(9472));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 5, 10, 438, DateTimeKind.Utc).AddTicks(9987));
                    ...
                    b.Property<DateTime>("ReservationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 0, 0, 0, 0, DateTimeKind.Utc));

                    b.Property<TimeSpan>("ReservationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("time")
                        .HasDefaultValue(new TimeSpan(0, 22, 5, 0, 0));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Slide", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 5, 10, 439, DateTimeKind.Utc).AddTicks(6806));
            ...
            modelBuilder.Entity("RMS.Core.Entities.Table", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 22, 5, 10, 440, DateTimeKind.Utc).AddTicks(2556));
